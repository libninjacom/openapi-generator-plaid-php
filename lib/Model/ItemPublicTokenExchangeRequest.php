...
/**
 * ItemPublicTokenExchangeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemPublicTokenExchangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPublicTokenExchangeRequest';
     ...
     * Sets public_token
     *
     * @param string $public_token Your `public_token`, obtained from the Link `onSuccess` callback or `/sandbox/item/public_token/create`.
     *
     * @return self
     */
