...
/**
 * WalletGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WalletGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletGetRequest';
     ...
     * Sets wallet_id
     *
     * @param string $wallet_id The ID of the e-wallet
     *
     * @return self
     */
    public function setWalletId($wallet_id)
    {
        ...
        if ((mb_strlen($wallet_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $wallet_id when calling WalletGetRequest., must be bigger than or equal to 1.');
        }
