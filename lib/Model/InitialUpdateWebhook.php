...
/**
 * InitialUpdateWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class InitialUpdateWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InitialUpdateWebhook';
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `INITIAL_UPDATE`
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param string|null $error The error code associated with the webhook.
     *
     * @return self
     */
