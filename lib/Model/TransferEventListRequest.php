...
/**
 * TransferEventListRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferEventListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferEventListRequest';
    ...
    protected static $openAPITypes = [
        ...
        'event_types' => '\OpenAPI\Client\Model\TransferEventType[]',
        'sweep_id' => 'string',
        'count' => 'int',
        'offset' => 'int',
    ...
    public const TRANSFER_TYPE_DEBIT = 'debit';
    public const TRANSFER_TYPE_CREDIT = 'credit';
    public const TRANSFER_TYPE_NULL = 'null';
    ...
    {
        return [
            self::TRANSFER_TYPE_DEBIT,
            self::TRANSFER_TYPE_CREDIT,
            self::TRANSFER_TYPE_NULL,
        ];
    }
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date The start datetime of transfers to list. This should be in RFC 3339 format (i.e. `2019-12-06T22:35:49Z`)
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The end datetime of transfers to list. This should be in RFC 3339 format (i.e. `2019-12-06T22:35:49Z`)
     *
     * @return self
     */
     ...
     * Sets transfer_id
     *
     * @param string|null $transfer_id Plaid’s unique identifier for a transfer.
     *
     * @return self
     */
     ...
     * Sets transfer_type
     *
     * @param string|null $transfer_type The type of transfer. This will be either `debit` or `credit`.  A `debit` indicates a transfer of money into your origination account; a `credit` indicates a transfer of money out of your origination account.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getTransferTypeAllowableValues();
        if (!is_null($transfer_type) && !in_array($transfer_type, $allowedValues, true)) {
     ...
     * Gets event_types
     *
     * @return \OpenAPI\Client\Model\TransferEventType[]|null
     */
     ...
     * Sets event_types
     *
     * @param \OpenAPI\Client\Model\TransferEventType[]|null $event_types Filter events by event type.
     *
     * @return self
     */
     ...
     * Sets sweep_id
     *
     * @param string|null $sweep_id Plaid’s unique identifier for a sweep.
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count The maximum number of transfer events to return. If the number of events matching the above parameters is greater than `count`, the most recent events will be returned.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 25)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferEventListRequest., must be smaller than or equal to 25.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferEventListRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets offset
     *
     * @param int|null $offset The offset into the list of transfer events. When `count`=25 and `offset`=0, the first 25 events will be returned. When `count`=25 and `offset`=25, the next 25 bank transfer events will be returned.
     *
     * @return self
     */
    public function setOffset($offset)
    {
        ...
        if (!is_null($offset) && ($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling TransferEventListRequest., must be bigger than or equal to 0.');
        }
