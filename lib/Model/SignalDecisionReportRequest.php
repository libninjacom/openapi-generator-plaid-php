...
/**
 * SignalDecisionReportRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SignalDecisionReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignalDecisionReportRequest';
    ...
    protected static $setters = [
        ...
        'days_funds_on_hold' => 'setDaysFundsOnHold'
    ];
    ...
    protected static $getters = [
        ...
        'days_funds_on_hold' => 'getDaysFundsOnHold'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['initiated'] = $data['initiated'] ?? null;
        $this->container['days_funds_on_hold'] = $data['days_funds_on_hold'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['days_funds_on_hold']) && ($this->container['days_funds_on_hold'] < 0)) {
            $invalidProperties[] = "invalid value for 'days_funds_on_hold', must be bigger than or equal to 0.";
        }
    ...
    public function setClientTransactionId($client_transaction_id)
    {
        if ((mb_strlen($client_transaction_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $client_transaction_id when calling SignalDecisionReportRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($client_transaction_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_transaction_id when calling SignalDecisionReportRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets initiated
     *
     * @param bool $initiated `true` if the ACH transaction was initiated, `false` otherwise.
     *
     * @return self
     */
    ...
    /**
     * Gets days_funds_on_hold
     *
     * @return int|null
     */
    public function getDaysFundsOnHold()
    {
        return $this->container['days_funds_on_hold'];
    }

    /**
     * Sets days_funds_on_hold
     *
     * @param int|null $days_funds_on_hold The actual number of days (hold time) since the ACH debit transaction that you wait before making funds available to your customers. The holding time could affect the ACH return rate. For example, use 0 if you make funds available to your customers instantly or the same day following the debit transaction, or 1 if you make funds available the next day following the debit initialization.
     *
     * @return self
     */
    public function setDaysFundsOnHold($days_funds_on_hold)
    {

        if (!is_null($days_funds_on_hold) && ($days_funds_on_hold < 0)) {
            throw new \InvalidArgumentException('invalid value for $days_funds_on_hold when calling SignalDecisionReportRequest., must be bigger than or equal to 0.');
        }

        $this->container['days_funds_on_hold'] = $days_funds_on_hold;
