...
/**
 * DepositSwitchAltCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DepositSwitchAltCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DepositSwitchAltCreateResponse';
     ...
     *
     * @param string $deposit_switch_id ID of the deposit switch. This ID is persisted throughout the lifetime of the deposit switch.
     *
     * @return self
     */
