...
/**
 * PaymentInitiationPaymentListRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationPaymentListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationPaymentListRequest';
     ...
     * Sets count
     *
     * @param int|null $count The maximum number of payments to return. If `count` is not specified, a maximum of 10 payments will be returned, beginning with the most recent payment before the cursor (if specified).
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 200)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PaymentInitiationPaymentListRequest., must be smaller than or equal to 200.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling PaymentInitiationPaymentListRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets cursor
     *
     * @param \DateTime|null $cursor A string in RFC 3339 format (i.e. \"2019-12-06T22:35:49Z\"). Only payments created before the cursor will be returned.
     *
     * @return self
     */
