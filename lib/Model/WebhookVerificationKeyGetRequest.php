...
/**
 * WebhookVerificationKeyGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookVerificationKeyGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookVerificationKeyGetRequest';
     ...
     * Sets key_id
     *
     * @param string $key_id The key ID ( `kid` ) from the JWT header.
     *
     * @return self
     */
