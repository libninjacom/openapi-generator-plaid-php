...
/**
 * AssetsErrorWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class AssetsErrorWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetsErrorWebhook';
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `ERROR`
     *
     * @return self
     */
     ...
     *
     * @param string $asset_report_id The ID associated with the Asset Report.
     *
     * @return self
     */
