...
/**
 * BankInitiatedReturnRisk Class Doc Comment
 *
 * @category Class
 ...
 */
class BankInitiatedReturnRisk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankInitiatedReturnRisk';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['risk_tier'] > 8)) {
            $invalidProperties[] = "invalid value for 'risk_tier', must be smaller than or equal to 8.";
        }
    ...
    public function setScore($score)
    {
        ...
        if (($score > 100)) {
            throw new \InvalidArgumentException('invalid value for $score when calling BankInitiatedReturnRisk., must be smaller than or equal to 100.');
        }
        if (($score < 0)) {
            throw new \InvalidArgumentException('invalid value for $score when calling BankInitiatedReturnRisk., must be bigger than or equal to 0.');
        }
    ...
    public function setRiskTier($risk_tier)
    {
        ...
        if (($risk_tier > 8)) {
            throw new \InvalidArgumentException('invalid value for $risk_tier when calling BankInitiatedReturnRisk., must be smaller than or equal to 8.');
        }
        if (($risk_tier < 1)) {
            throw new \InvalidArgumentException('invalid value for $risk_tier when calling BankInitiatedReturnRisk., must be bigger than or equal to 1.');
        }
