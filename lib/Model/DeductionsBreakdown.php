...
/**
 * DeductionsBreakdown Class Doc Comment
 *
 * @category Class
 ...
 */
class DeductionsBreakdown implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeductionsBreakdown';
     ...
     * Sets current_amount
     *
     * @param float|null $current_amount Raw amount of the deduction
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the deduction line item
     *
     * @return self
     */
