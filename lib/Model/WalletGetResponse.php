 ...
 */
class WalletGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletGetResponse';
     ...
     * Sets wallet_id
     *
     * @param string $wallet_id A unique ID identifying the e-wallet
     *
     * @return self
     */
