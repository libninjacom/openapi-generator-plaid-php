...
/**
 * AccountsGetResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountsGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountsGetResponse';
     ...
     * Sets accounts
     *
     * @param \OpenAPI\Client\Model\AccountBase[] $accounts An array of financial institution accounts associated with the Item. If `/accounts/balance/get` was called, each account will include real-time balance information.
     *
     * @return self
     */
