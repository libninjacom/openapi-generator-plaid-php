...
/**
 * TransferRepayment Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferRepayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferRepayment';
     ...
     * Sets repayment_id
     *
     * @param string $repayment_id Identifier of the repayment.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime $created The datetime when the repayment occurred, in RFC 3339 format.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Decimal amount of the repayment as it appears on your account ledger.
     *
     * @return self
     */
