...
/**
 * AccountsGetRequestOptions Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountsGetRequestOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountsGetRequestOptions';
     ...
     * Sets account_ids
     *
     * @param string[]|null $account_ids An array of `account_ids` to retrieve for the Account.
     *
     * @return self
     */
