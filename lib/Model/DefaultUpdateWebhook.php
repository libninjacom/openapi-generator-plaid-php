...
/**
 * DefaultUpdateWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class DefaultUpdateWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DefaultUpdateWebhook';
     ...
     *
     * @param float $new_transactions The number of new transactions detected since the last time this webhook was fired.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The `item_id` of the Item the webhook relates to.
     *
     * @return self
     */
