...
class PhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_MOBILE1 = 'mobile1';
     ...
     * Sets data
     *
     * @param string $data The phone number.
     *
     * @return self
     */
     ...
     * Sets primary
     *
     * @param bool $primary When `true`, identifies the phone number as the primary number on an account.
     *
     * @return self
     */
