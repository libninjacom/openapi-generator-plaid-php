...
/**
 * InstitutionsGetByIdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InstitutionsGetByIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstitutionsGetByIdRequest';
    ...
    protected static $openAPITypes = [
        ...
        'options' => '\OpenAPI\Client\Model\InstitutionsGetByIdRequestOptions'
    ];
     ...
     * Sets institution_id
     *
     * @param string $institution_id The ID of the institution to get details about
     *
     * @return self
     */
    public function setInstitutionId($institution_id)
    {
        ...
        if ((mb_strlen($institution_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $institution_id when calling InstitutionsGetByIdRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\InstitutionsGetByIdRequestOptions|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\InstitutionsGetByIdRequestOptions|null $options options
     *
     * @return self
     */
