...
class Employer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'employer_id' => 'string',
        'name' => 'string',
        'address' => '\OpenAPI\Client\Model\AddressDataNullable',
     ...
     * Sets employer_id
     *
     * @param string $employer_id Plaid's unique identifier for the employer.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the employer
     *
     * @return self
     */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\AddressDataNullable
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\AddressDataNullable $address address
     *
     * @return self
     */
     ...
     *
     * @param float $confidence_score A number from 0 to 1 indicating Plaid's level of confidence in the pairing between the employer and the institution (not yet implemented).
     *
     * @return self
     */
