...
/**
 * PaymentInitiationPaymentReverseRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationPaymentReverseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationPaymentReverseRequest';
     ...
     * Sets payment_id
     *
     * @param string $payment_id The ID of the payment to reverse
     *
     * @return self
     */
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling PaymentInitiationPaymentReverseRequest., must be bigger than or equal to 1.');
        }
