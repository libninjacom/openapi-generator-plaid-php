...
/**
 * PaymentInitiationPaymentListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationPaymentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationPaymentListResponse';
    ...
    protected static $openAPITypes = [
        'payments' => '\OpenAPI\Client\Model\PaymentInitiationPayment[]',
     ...
     * Gets payments
     *
     * @return \OpenAPI\Client\Model\PaymentInitiationPayment[]
     */
     ...
     * Sets payments
     *
     * @param \OpenAPI\Client\Model\PaymentInitiationPayment[] $payments An array of payments that have been created, associated with the given `client_id`.
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param \DateTime $next_cursor The value that, when used as the optional `cursor` parameter to `/payment_initiation/payment/list`, will return the next unreturned payment as its first payment.
     *
     * @return self
     */
