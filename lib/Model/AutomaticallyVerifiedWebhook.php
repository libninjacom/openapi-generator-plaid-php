...
/**
 * AutomaticallyVerifiedWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class AutomaticallyVerifiedWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomaticallyVerifiedWebhook';
     ...
     * Sets webhook_type
     *
     * @param string $webhook_type `AUTH`
     *
     * @return self
     */
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `AUTOMATICALLY_VERIFIED`
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param string $account_id The `account_id` of the account associated with the webhook
     *
     * @return self
     */
