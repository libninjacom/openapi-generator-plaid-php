...
/**
 * ItemPublicTokenCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemPublicTokenCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPublicTokenCreateResponse';
     ...
     * Sets public_token
     *
     * @param string $public_token A `public_token` for the particular Item corresponding to the specified `access_token`
     *
     * @return self
     */
