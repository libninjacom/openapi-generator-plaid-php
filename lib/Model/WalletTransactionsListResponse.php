...
/**
 * WalletTransactionsListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class WalletTransactionsListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletTransactionsListResponse';
    ...
    protected static $openAPITypes = [
        'transactions' => '\OpenAPI\Client\Model\WalletTransaction[]',
        'next_cursor' => 'string',
        'request_id' => 'string'
    ];
     ...
     * Gets transactions
     *
     * @return \OpenAPI\Client\Model\WalletTransaction[]
     */
     ...
     * Sets transactions
     *
     * @param \OpenAPI\Client\Model\WalletTransaction[] $transactions An array of transactions of an e-wallet, associated with the given `wallet_id`
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Cursor used for fetching transactions created before the latest transaction provided in this response
     *
     * @return self
     */
