...
/**
 * TransactionsRecurringGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionsRecurringGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionsRecurringGetRequest';
     ...
     * Sets account_ids
     *
     * @param string[] $account_ids A list of `account_ids` to retrieve for the Item  Note: An error will be returned if a provided `account_id` is not associated with the Item.
     *
     * @return self
     */
