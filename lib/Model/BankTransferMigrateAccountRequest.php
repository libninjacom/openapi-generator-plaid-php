...
/**
 * BankTransferMigrateAccountRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferMigrateAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferMigrateAccountRequest';
     ...
     * Sets account_number
     *
     * @param string $account_number The user's account number.
     *
     * @return self
     */
     ...
     * Sets routing_number
     *
     * @param string $routing_number The user's routing number.
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string $account_type The type of the bank account (`checking` or `savings`).
     *
     * @return self
     */
