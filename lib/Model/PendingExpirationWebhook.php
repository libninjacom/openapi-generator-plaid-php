...
/**
 * PendingExpirationWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class PendingExpirationWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PendingExpirationWebhook';
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `PENDING_EXPIRATION`
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $consent_expiration_time The date and time at which the Item's access consent will expire, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format
     *
     * @return self
     */
