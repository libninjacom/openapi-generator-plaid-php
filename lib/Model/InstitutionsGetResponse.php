...
/**
 * InstitutionsGetResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class InstitutionsGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstitutionsGetResponse';
    ...
    {
        $this->container['institutions'] = $data['institutions'] ?? null;
     ...
     * Sets institutions
     *
     * @param \OpenAPI\Client\Model\Institution[] $institutions A list of Plaid institutions
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total The total number of institutions available via this endpoint
     *
     * @return self
     */
