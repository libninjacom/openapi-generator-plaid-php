...
/**
 * IncomeVerificationDocumentsDownloadRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IncomeVerificationDocumentsDownloadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomeVerificationDocumentsDownloadRequest';
     ...
     *
     * @param string|null $income_verification_id The ID of the verification.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets access_token
     *
     * @param string|null $access_token The access token associated with the Item data is being requested for.
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param string|null $document_id The document ID to download. If passed, a single document will be returned in the resulting zip file, rather than all document
     *
     * @return self
     */
