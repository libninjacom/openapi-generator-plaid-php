...
/**
 * BankTransferSweepListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferSweepListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferSweepListResponse';
    ...
    protected static $openAPITypes = [
        'sweeps' => '\OpenAPI\Client\Model\BankTransferSweep[]',
        'request_id' => 'string'
    ];
    ...
    {
        $this->container['sweeps'] = $data['sweeps'] ?? null;
     ...
     * Sets sweeps
     *
     * @param \OpenAPI\Client\Model\BankTransferSweep[] $sweeps sweeps
     *
     * @return self
     */
