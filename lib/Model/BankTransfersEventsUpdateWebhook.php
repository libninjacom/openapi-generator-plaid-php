...
/**
 * BankTransfersEventsUpdateWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransfersEventsUpdateWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransfersEventsUpdateWebhook';
     ...
     * Sets webhook_type
     *
     * @param string $webhook_type `BANK_TRANSFERS`
     *
     * @return self
     */
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `BANK_TRANSFERS_EVENTS_UPDATE`
     *
     * @return self
     */
