...
/**
 * ProcessorTokenCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ProcessorTokenCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessorTokenCreateResponse';
     ...
     *
     * @param string $processor_token The `processor_token` that can then be used by the Plaid partner to make API requests
     *
     * @return self
     */
