...
/**
 * TransferListRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferListRequest';
     ...
     * Sets count
     *
     * @param int|null $count The maximum number of transfers to return.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 25)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferListRequest., must be smaller than or equal to 25.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferListRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets offset
     *
     * @param int|null $offset The number of transfers to skip before returning results.
     *
     * @return self
     */
    public function setOffset($offset)
    {
        ...
        if (!is_null($offset) && ($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling TransferListRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $origination_account_id Filter transfers to only those originated through the specified origination account.
     *
     * @return self
     */
