...
/**
 * PaymentInitiationRecipientGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationRecipientGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationRecipientGetRequest';
    ...
    public function setRecipientId($recipient_id)
    {
        ...
        if ((mb_strlen($recipient_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipient_id when calling PaymentInitiationRecipientGetRequest., must be bigger than or equal to 1.');
        }
