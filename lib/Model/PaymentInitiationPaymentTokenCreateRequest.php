...
/**
 * PaymentInitiationPaymentTokenCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationPaymentTokenCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationPaymentTokenCreateRequest';
     ...
     * Sets payment_id
     *
     * @param string $payment_id The `payment_id` returned from `/payment_initiation/payment/create`.
     *
     * @return self
     */
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling PaymentInitiationPaymentTokenCreateRequest., must be bigger than or equal to 1.');
        }
