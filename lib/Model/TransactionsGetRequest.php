...
/**
 * TransactionsGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionsGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionsGetRequest';
    ...
    protected static $openAPITypes = [
        'client_id' => 'string',
        'options' => '\OpenAPI\Client\Model\TransactionsGetRequestOptions',
        'access_token' => 'string',
        'secret' => 'string',
        'start_date' => '\DateTime',
        'end_date' => '\DateTime'
     ...
     * Gets options
     *
     * @return \OpenAPI\Client\Model\TransactionsGetRequestOptions|null
     */
     ...
     * Sets options
     *
     * @param \OpenAPI\Client\Model\TransactionsGetRequestOptions|null $options options
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date The earliest date for which data should be returned. Dates should be formatted as YYYY-MM-DD.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime $end_date The latest date for which data should be returned. Dates should be formatted as YYYY-MM-DD.
     *
     * @return self
     */
