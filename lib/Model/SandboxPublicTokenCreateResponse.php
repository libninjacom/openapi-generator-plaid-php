...
/**
 * SandboxPublicTokenCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SandboxPublicTokenCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SandboxPublicTokenCreateResponse';
    ...
    {
        $this->container['public_token'] = $data['public_token'] ?? null;
     ...
     * Sets public_token
     *
     * @param string $public_token A public token that can be exchanged for an access token using `/item/public_token/exchange`
     *
     * @return self
     */
