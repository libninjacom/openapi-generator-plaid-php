...
/**
 * ProcessorBankTransferCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ProcessorBankTransferCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProcessorBankTransferCreateResponse';
    ...
    protected static $openAPITypes = [
        'bank_transfer' => '\OpenAPI\Client\Model\BankTransfer',
        'request_id' => 'string'
    ];
    ...
    {
        $this->container['bank_transfer'] = $data['bank_transfer'] ?? null;
     ...
     * Sets bank_transfer
     *
     * @param \OpenAPI\Client\Model\BankTransfer $bank_transfer bank_transfer
     *
     * @return self
     */
