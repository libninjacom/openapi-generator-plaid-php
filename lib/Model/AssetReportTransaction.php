...
class AssetReportTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['original_description'] === null) {
            $invalidProperties[] = "'original_description' can't be null";
        }
     ...
     *
     * @param string|null $date_transacted The date on which the transaction took place, in IS0 8601 format.
     *
     * @return self
     */
