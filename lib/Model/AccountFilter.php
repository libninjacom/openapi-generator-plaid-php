...
/**
 * AccountFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountFilter';
     ...
     * Sets depository
     *
     * @param string[]|null $depository A list of account subtypes to be filtered.
     *
     * @return self
     */
     ...
     * Sets credit
     *
     * @param string[]|null $credit A list of account subtypes to be filtered.
     *
     * @return self
     */
     ...
     * Sets loan
     *
     * @param string[]|null $loan A list of account subtypes to be filtered.
     *
     * @return self
     */
     ...
     * Sets investment
     *
     * @param string[]|null $investment A list of account subtypes to be filtered.
     *
     * @return self
     */
