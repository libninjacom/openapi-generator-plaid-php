...
/**
 * TransactionsSyncRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionsSyncRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionsSyncRequest';
     ...
     * Sets cursor
     *
     * @param string|null $cursor The cursor value represents the last update requested. Providing it will cause the response to only return changes after this update. If omitted, the entire history of updates will be returned, starting with the first-added transactions on the item. Note: The upper-bound length of this cursor is 256 characters of base64.
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count The number of transaction updates to fetch.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 500)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransactionsSyncRequest., must be smaller than or equal to 500.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransactionsSyncRequest., must be bigger than or equal to 1.');
        }
