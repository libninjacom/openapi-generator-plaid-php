...
/**
 * BankTransferSweep Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferSweep implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferSweep';
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The datetime when the sweep occurred, in RFC 3339 format.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount The amount of the sweep.
     *
     * @return self
     */
