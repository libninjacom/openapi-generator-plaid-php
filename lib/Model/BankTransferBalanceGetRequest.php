...
/**
 * BankTransferBalanceGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferBalanceGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferBalanceGetRequest';
     ...
     *
     * @param string|null $origination_account_id If multiple origination accounts are available, `origination_account_id` must be used to specify the account for which balance will be returned.
     *
     * @return self
     */
