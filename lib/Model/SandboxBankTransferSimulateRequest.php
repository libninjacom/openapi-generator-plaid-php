...
/**
 * SandboxBankTransferSimulateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SandboxBankTransferSimulateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SandboxBankTransferSimulateRequest';
     ...
     * Sets event_type
     *
     * @param string $event_type The asynchronous event to be simulated. May be: `posted`, `failed`, or `reversed`.  An error will be returned if the event type is incompatible with the current transfer status. Compatible status --> event type transitions include:  `pending` --> `failed`  `pending` --> `posted`  `posted` --> `reversed`
     *
     * @return self
     */
     ...
     * Gets failure_reason
     *
     * @return \OpenAPI\Client\Model\BankTransferFailure|null
     */
     ...
     * Sets failure_reason
     *
     * @param \OpenAPI\Client\Model\BankTransferFailure|null $failure_reason failure_reason
     *
     * @return self
     */
