...
/**
 * IncomeVerificationPaystubsGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IncomeVerificationPaystubsGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomeVerificationPaystubsGetRequest';
     ...
     *
     * @param string|null $income_verification_id The ID of the verification for which to get paystub information.
     *
     * @return self
     * @deprecated
     */
