 ...
 */
class NetPay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetPay';
     ...
     * Sets current_amount
     *
     * @param float|null $current_amount Raw amount of the net pay for the pay period
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the net pay
     *
     * @return self
     */
     ...
     * Sets ytd_amount
     *
     * @param float|null $ytd_amount The year-to-date amount of the net pay
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param \OpenAPI\Client\Model\Total|null $total total
     *
     * @return self
     * @deprecated
     */
