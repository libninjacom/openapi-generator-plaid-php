...
/**
 * BankTransferMigrateAccountResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferMigrateAccountResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferMigrateAccountResponse';
     ...
     * Sets access_token
     *
     * @param string $access_token The Plaid `access_token` for the newly created Item.
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param string $account_id The Plaid `account_id` for the newly created Item.
     *
     * @return self
     */
