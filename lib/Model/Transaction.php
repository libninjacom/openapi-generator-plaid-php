...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pending_transaction_id'] === null) {
            $invalidProperties[] = "'pending_transaction_id' can't be null";
        }
        ...
        if ($this->container['payment_meta'] === null) {
            $invalidProperties[] = "'payment_meta' can't be null";
        }
     ...
     *
     * @param string $pending_transaction_id The ID of a posted transaction's associated pending transaction, where applicable.
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string[] $category A hierarchical array of the categories to which this transaction belongs. For a full list of categories, see [`/categories/get`](https://plaid.com/docs/api/products/#categoriesget).  If the `transactions` object was returned by an Assets endpoint such as `/asset_report/get/` or `/asset_report/pdf/get`, this field will only appear in an Asset Report with Insights.
     *
     * @return self
     */
     ...
     * Gets payment_meta
     *
     * @return \OpenAPI\Client\Model\PaymentMeta
     */
     ...
     * Sets payment_meta
     *
     * @param \OpenAPI\Client\Model\PaymentMeta $payment_meta payment_meta
     *
     * @return self
     */
     ...
     * Sets account_owner
     *
     * @param string $account_owner The name of the account owner. This field is not typically populated and only relevant when dealing with sub-accounts.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The merchant name or transaction description.  If the `transactions` object was returned by a Transactions endpoint such as `/transactions/get`, this field will always appear. If the `transactions` object was returned by an Assets endpoint such as `/asset_report/get/` or `/asset_report/pdf/get`, this field will only appear in an Asset Report with Insights.
     *
     * @return self
     */
