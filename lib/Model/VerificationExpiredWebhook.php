...
/**
 * VerificationExpiredWebhook Class Doc Comment
 *
 * @category Class
 ...
 */
class VerificationExpiredWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationExpiredWebhook';
     ...
     * Sets webhook_code
     *
     * @param string $webhook_code `VERIFICATION_EXPIRED`
     *
     * @return self
     */
