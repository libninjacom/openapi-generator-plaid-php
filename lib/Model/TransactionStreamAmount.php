...
/**
 * TransactionStreamAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class TransactionStreamAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionStreamAmount';
     ...
     * Sets amount
     *
     * @param float|null $amount represents the numerical value of an amount.
     *
     * @return self
     */
     ...
     *
     * @param string|null $iso_currency_code The ISO-4217 currency code of the amount. Always `null` if `unofficial_currency_code` is non-`null`.  See the [currency code schema](https://plaid.com/docs/api/accounts#currency-code-schema) for a full listing of supported `iso_currency_code`s.
     *
     * @return self
     */
     ...
     *
     * @param string|null $unofficial_currency_code The unofficial currency code of the amount. Always `null` if `iso_currency_code` is non-`null`. Unofficial currency codes are used for currencies that do not have official ISO currency codes, such as cryptocurrencies and the currencies of certain countries.
     *
     * @return self
     */
