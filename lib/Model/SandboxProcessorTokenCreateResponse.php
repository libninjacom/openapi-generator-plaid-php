...
/**
 * SandboxProcessorTokenCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SandboxProcessorTokenCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SandboxProcessorTokenCreateResponse';
     ...
     *
     * @param string $processor_token A processor token that can be used to call the `/processor/` endpoints.
     *
     * @return self
     */
