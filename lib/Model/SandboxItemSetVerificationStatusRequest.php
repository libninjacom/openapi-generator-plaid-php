...
/**
 * SandboxItemSetVerificationStatusRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SandboxItemSetVerificationStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SandboxItemSetVerificationStatusRequest';
     ...
     *
     * @param string $verification_status The verification status to set the account to.
     *
     * @return self
     */
