...
/**
 * LinkTokenGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class LinkTokenGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkTokenGetRequest';
     ...
     * Sets link_token
     *
     * @param string $link_token A `link_token` from a previous invocation of `/link/token/create`
     *
     * @return self
     */
