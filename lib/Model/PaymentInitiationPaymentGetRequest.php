...
/**
 * PaymentInitiationPaymentGetRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInitiationPaymentGetRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInitiationPaymentGetRequest';
    ...
    public function setPaymentId($payment_id)
    {
        ...
        if ((mb_strlen($payment_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_id when calling PaymentInitiationPaymentGetRequest., must be bigger than or equal to 1.');
        }
