...
class Email implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets primary
     *
     * @param bool $primary When `true`, identifies the email address as the primary email on an account.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of email account as described by the financial institution.
     *
     * @return self
     */
