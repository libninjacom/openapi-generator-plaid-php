...
/**
 * TransferRepaymentListRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferRepaymentListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferRepaymentListRequest';
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date The start datetime of repayments to return (RFC 3339 format).
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The end datetime of repayments to return (RFC 3339 format).
     *
     * @return self
     */
    ...
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 25)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferRepaymentListRequest., must be smaller than or equal to 25.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling TransferRepaymentListRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOffset($offset)
    {
        ...
        if (!is_null($offset) && ($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling TransferRepaymentListRequest., must be bigger than or equal to 0.');
        }
