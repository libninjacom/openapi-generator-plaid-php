...
/**
 * TransferIntentCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class TransferIntentCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferIntentCreate';
     ...
     * Sets id
     *
     * @param string $id Plaid's unique identifier for the transfer intent object.
     *
     * @return self
     */
     ...
     *
     * @param string $origination_account_id Plaid’s unique identifier for the origination account for the intent. If not provided, the default account will be used.
     *
     * @return self
     */
    ...
    public function setMetadata($metadata)
    {
        ...
        if (!is_null($metadata) && (count($metadata) > 50)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling TransferIntentCreate., number of items must be less than or equal to 50.');
        }
