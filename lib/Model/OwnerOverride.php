...
/**
 * OwnerOverride Class Doc Comment
 *
 * @category Class
 ...
 */
class OwnerOverride implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OwnerOverride';
     ...
     * Sets names
     *
     * @param string[] $names A list of names associated with the account by the financial institution. These should always be the names of individuals, even for business accounts. Note that the same name data will be used for all accounts associated with an Item.
     *
     * @return self
     */
     ...
     * Sets phone_numbers
     *
     * @param \OpenAPI\Client\Model\PhoneNumber[] $phone_numbers A list of phone numbers associated with the account.
     *
     * @return self
     */
     ...
     * Sets emails
     *
     * @param \OpenAPI\Client\Model\Email[] $emails A list of email addresses associated with the account.
     *
     * @return self
     */
     ...
     * Sets addresses
     *
     * @param \OpenAPI\Client\Model\Address[] $addresses Data about the various addresses associated with the account.
     *
     * @return self
     */
