...
/**
 * EmployersSearchRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EmployersSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployersSearchRequest';
     ...
     * Sets query
     *
     * @param string $query The employer name to be searched for.
     *
     * @return self
     */
     ...
     * Sets products
     *
     * @param string[] $products The Plaid products the returned employers should support. Currently, this field must be set to `\"deposit_switch\"`.
     *
     * @return self
     */
