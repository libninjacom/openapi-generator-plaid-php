 ...
 */
class CategoriesGetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoriesGetResponse';
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\Category[] $categories An array of all of the transaction categories used by Plaid.
     *
     * @return self
     */
