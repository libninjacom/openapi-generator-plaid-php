...
/**
 * BankTransferCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BankTransferCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BankTransferCreateRequest';
    ...
    public function setIdempotencyKey($idempotency_key)
    {
        if ((mb_strlen($idempotency_key) > 50)) {
            throw new \InvalidArgumentException('invalid length for $idempotency_key when calling BankTransferCreateRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 10)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BankTransferCreateRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomTag($custom_tag)
    {
        if (!is_null($custom_tag) && (mb_strlen($custom_tag) > 100)) {
            throw new \InvalidArgumentException('invalid length for $custom_tag when calling BankTransferCreateRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setMetadata($metadata)
    {
        ...
        if (!is_null($metadata) && (count($metadata) > 50)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling BankTransferCreateRequest., number of items must be less than or equal to 50.');
        }
