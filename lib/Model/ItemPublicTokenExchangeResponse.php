...
/**
 * ItemPublicTokenExchangeResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemPublicTokenExchangeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPublicTokenExchangeResponse';
     ...
     * Sets item_id
     *
     * @param string $item_id The `item_id` value of the Item associated with the returned `access_token`
     *
     * @return self
     */
