...
/**
 * IncomeVerificationCreateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class IncomeVerificationCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IncomeVerificationCreateResponse';
     ...
     *
     * @param string $income_verification_id ID of the verification. This ID is persisted throughout the lifetime of the verification.
     *
     * @return self
     */
