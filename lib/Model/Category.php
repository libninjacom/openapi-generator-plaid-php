...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hierarchy'] = $data['hierarchy'] ?? null;
    }
     ...
     * Sets category_id
     *
     * @param string $category_id An identifying number for the category. `category_id` is a Plaid-specific identifier and does not necessarily correspond to merchant category codes.
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string $group `place` for physical transactions or `special` for other transactions such as bank charges.
     *
     * @return self
     */
     ...
     * Sets hierarchy
     *
     * @param string[] $hierarchy A hierarchical array of the categories to which this `category_id` belongs.
     *
     * @return self
     */
